...
interface ToStudyProps {
  initialToStudies: ToStudyValue[];
}

const ToStudy: React.FC<ToStudyProps> = ({ initialToStudies }) => {
  ...
  const [submittedToStudyValue, setSubmittedToStudyValue] =
    useState<ToStudyValue[]>(initialToStudies);
